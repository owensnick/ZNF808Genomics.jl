...
using Plots, StatsPlots, Measures, Humanize, ImageFiltering
...
function loadall()
    ...
    stagelabels = Dict("D0" => "S0", "DE" => "S1", "S2" => "S2", "S3" => "S3", "S4" => "S4", "S5" => "S5", "S6" => "S6", "S7" => "S7");

    genetss, lrois, mer11, genemodels, laser_dorsal_hep, human_embryo_rnaseq, meta, counts, ncounts, enrichrgenes, peakmeta, FM, stagelabels
